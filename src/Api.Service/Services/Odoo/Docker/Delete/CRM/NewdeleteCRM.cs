...
namespace Api.Service.Services.Odoo.Docker.Delete.CRM
{
    public class NewdeleteCRM
    {
        ...
        public NewdeleteCRM(string CustomerEmail, string CustomerTag)
        {
        ...
        private void DeleteSAAS()
        {
            ...
            writer.WriteLine("docker container rm -f " + nomecontainer + "_odoo11_1"); //remove container odoo
            writer.WriteLine("docker container rm -f " + nomecontainer + "_db_1"); //remove container postgree
            writer.WriteLine("docker network rm " + nomecontainer + "_default"); //remove network        
            writer.Close();
